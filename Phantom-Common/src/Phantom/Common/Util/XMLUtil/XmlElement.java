...
public class XmlElement implements Serializable {
	...
	private List<XmlElement> content = new ArrayList<>();// 内容
	private Map<String,List<XmlElement>> children = new HashMap<String,List<XmlElement>>();// 子节点
	...
	public void removeXmlElement(XmlElement delegateXmlElement) {
		List<XmlElement> namedChildren = /*(List) */children.get(delegateXmlElement.getName());
	...
	public List<XmlElement> getChildElements(String childName) {
		List<XmlElement> childElements = /*(List)*/ children.get(childName);
	 ...
	 * @Description 获取文本内容
	 */
	public List<XmlElement> getContent() {
		return content;
	}
	...
	public void getContentString(StringBuffer buffer, String indentation) {
		Iterator<XmlElement> iter = content.iterator();
		while (iter.hasNext()) {
